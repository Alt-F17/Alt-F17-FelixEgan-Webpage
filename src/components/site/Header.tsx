  ...
  return (
    <header className="sticky top-0 z-40 border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <Link to="/" className="min-w-0 truncate text-sm font-semibold uppercase tracking-[0.2em] text-zinc-100">
          Felix Egan Studio
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden rounded-md border border-zinc-700 px-3 py-2 text-xs font-semibold text-zinc-100 hover:border-zinc-500 sm:inline-flex"
          >
