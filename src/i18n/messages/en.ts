...
export const enMessages: AppMessages = {
  ...
  contact: {
    ...
    subtitle: "Request a discovery call and I will follow up with next steps.",
  ...
  leadForm: {
    ...
    subtitle: "Company owners and individuals can use this form.",
    fullName: "Full Name",
    email: "Email",
    ...
    optionEmail: "Email",
    optionPhone: "Phone",
    success: "Thanks. Your discovery call request was sent.",
